...
//https://github.com/gayanvoice/android-animations-kotlin  to see the animations preview
class Attention {
    ...
    fun Tada (view: View) :AnimatorSet{
        ...
        val object1:ObjectAnimator = ObjectAnimator.ofFloat(view, "scaleX", 1f, 0.9f, 0.9f,1f )
        val object2:ObjectAnimator = ObjectAnimator.ofFloat(view, "scaleY", 1f, 0.9f, 0.9f,1f)
        val object3:ObjectAnimator = ObjectAnimator.ofFloat(view, "rotation", 0f, -2f, 2f, -2f, 2f,0f)
        object1.repeatCount = ObjectAnimator.INFINITE
        object2.repeatCount = ObjectAnimator.INFINITE
        object3.repeatCount = ObjectAnimator.INFINITE
